...
{
  "$end", "error", "$undefined", "QUERY", "PI", "PHI", "NAME", "NUMBER",
  "'-'", "'+'", "'*'", "'/'", "UMINUS", "'\\n'", "'='", "'('", "')'",
  "$accept", "statement_list", "statement", "expression", YY_NULL
};
#endif
...
{
       6,   -11,   -10,     1,     8,   -11,    25,    25,    20,    -5,
      37,    25,    25,    25,   -11,   -11,   -11,   -11,    28,   -11,
      21,   -11,    25,    25,    25,    25,    37,    37,    37,   -11,
     -11,    -8,    -8,   -11,   -11
};
...
{
       0,     7,    15,    16,    18,    17,     0,     0,     0,     0,
       8,     0,     0,     0,    15,    16,    18,    13,     0,     1,
       0,     2,     0,     0,     0,     0,     5,     6,     4,    14,
       3,    10,     9,    11,    12
};
...
{
      17,    18,    24,    25,    11,    26,    27,    28,    21,     1,
       2,     3,     4,     5,     6,    12,    31,    32,    33,    34,
      19,     7,    13,     1,     2,     3,     4,     5,     6,    14,
      15,    16,     5,     6,    30,     7,    22,    23,    24,    25,
       7,    20,     0,     0,    29,    22,    23,    24,    25
};

static const yytype_int8 yycheck[] =
{
       6,     7,    10,    11,    14,    11,    12,    13,    13,     3,
       4,     5,     6,     7,     8,    14,    22,    23,    24,    25,
       0,    15,    14,     3,     4,     5,     6,     7,     8,     4,
       5,     6,     7,     8,    13,    15,     8,     9,    10,    11,
      15,     8,    -1,    -1,    16,     8,     9,    10,    11
};
...
static const yytype_uint8 yystos[] =
{
      ...
      20,    14,    14,    14,     4,     5,     6,    20,    20,     0,
      19,    13,     8,     9,    10,    11,    20,    20,    20,    16,
      13,    20,    20,    20,    20
};
...
#line 40 "calc.y" /* yacc.c:1646  */
    { if((yyvsp[0].dval) == 0){ (yyval.dval) = (yyvsp[-2].dval); printf("divide by zero\n");}else{(yyval.dval) = (yyvsp[-2].dval) / (yyvsp[0].dval); }}
